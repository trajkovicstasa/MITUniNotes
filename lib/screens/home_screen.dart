...
import 'package:notes_hub/screens/inner_screen/collection_notes_screen.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const TitelesTextWidget(label: "Izdvojene kolekcije"),
                ...
                child: ListView(
                  ...
                  children: [
                    _CollectionCard(
                      ...
                      colors: const [Color(0xFF1F6FEB), Color(0xFF0EA5E9)],
                      icon: Icons.public_rounded,
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => const CollectionNotesScreen.publicNotes(),
                          ),
                        );
                      },
                    ),
                    ...
                    _CollectionCard(
                      ...
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) =>
                                const CollectionNotesScreen.premiumNotes(),
                          ),
                        );
                      },
                    ),
                    ...
                    _CollectionCard(
                      ...
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) =>
                                const CollectionNotesScreen.personalLibrary(),
                          ),
                        );
                      },
                    ),
